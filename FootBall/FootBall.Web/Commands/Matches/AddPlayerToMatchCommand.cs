...
{
    public class AddPlayerToMatchCommand : ICommand
    {
        ...
        public AddPlayerToMatchCommand(IPlayerRepository playerRepository, IRepository<Match> matchRepository, int userVkId, int matchId)
        {
